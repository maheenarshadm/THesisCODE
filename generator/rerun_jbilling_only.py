"""Re-runs run_dynamosa (dynamosa_nsga2, budget 1x, seed 0) for jBilling
...
generator/experiment_runs/jBilling__dynamosa_nsga2__budget1x__seed0.pkl/.json
only."""
import json
import os
import sys
...
if __name__ == '__main__':
    ...
    records = [r for r in compiled if r['case_study'] == 'jBilling']
    print(f"population_size={POPULATION_SIZE}, generations={BASE_GENERATIONS}, seed=0\n")
    _run_one(run_dynamosa, records, 'jBilling', 'dynamosa_nsga2', budget_multiplier=1, seed=0,
